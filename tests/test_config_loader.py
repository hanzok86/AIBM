...
class TestConfigLoader(unittest.TestCase):
    ...
    def test_load_config(self):
        ...
        self.assertEqual(virology_cfg.max_tokens, 3000)
        self.assertEqual(virology_cfg.temperature, 0.6)
    ...
    def test_agent_config(self):
        ...
        self.assertEqual(agent_config.max_tokens, 3000)
        self.assertEqual(agent_config.temperature, 0.6)
